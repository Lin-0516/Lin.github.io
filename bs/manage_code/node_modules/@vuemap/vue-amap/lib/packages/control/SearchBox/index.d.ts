...
export declare const ElAmapSearchBox: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "visible" | "reEventWhenUpdate" | ("citylimit" | "inputCustom" | "outPutDirAuto" | "closeResultOnScroll" | "debounce")>;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
