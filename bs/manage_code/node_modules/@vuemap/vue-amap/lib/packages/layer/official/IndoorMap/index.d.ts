...
export declare const ElAmapLayerIndoorMap: {
    new (...args: any[]): {
        ...
        }>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "visible" | "reEventWhenUpdate" | "hideFloorBar">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
