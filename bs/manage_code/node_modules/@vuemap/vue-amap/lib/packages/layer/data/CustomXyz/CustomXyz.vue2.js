...
var vue = require('vue');
var amapXyzLayer = require('@vuemap/amap-xyz-layer');
...
var script = vue.defineComponent({
  ...
  methods: {
    __initComponent(options) {
      this.$amapComponent = new amapXyzLayer.CustomXyzLayer(this.$parentComponent, options);
    },
    destroyComponent() {
...
//# sourceMappingURL=CustomXyz.vue2.js.map
