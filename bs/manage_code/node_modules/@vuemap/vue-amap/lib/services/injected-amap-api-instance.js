...
var amapApiLoader = require('./amap-api-loader.js');
...
const initAMapApiLoader = (config) => {
  ...
  if (!exports.lazyAMapApiLoaderInstance) {
    if (config.offline) {
      ...
      exports.lazyAMapApiLoaderInstance = amapApiLoader.default(config);
    }
  }
...
//# sourceMappingURL=injected-amap-api-instance.js.map
