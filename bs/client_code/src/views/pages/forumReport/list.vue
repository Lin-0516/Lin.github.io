    ...
    <div class="list-page">
		...
		<div class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" v-if="btnAuth('forum_report','新增')" @click="addClick">新增</el-button>
			</div>
		</div>
                ...
                <div class="table_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="帖子标题" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.title}}
							</template>
						</el-table-column>
						<el-table-column label="举报人账号" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.reportUsername}}
							</template>
						</el-table-column>
						<el-table-column label="被举报人账号" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.reportedUsername}}
							</template>
						</el-table-column>
						<el-table-column label="举报图片" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								<div v-if="scope.row.images">
									<el-image v-if="scope.row.images.substring(0,4)=='http'" preview-teleported
										...
										:src="scope.row.images.split(',')[0]" style="width:100px;height:100px" @click.stop></el-image>
									<el-image v-else preview-teleported
										:preview-src-list="[baseUrl+scope.row.images.split(',')[0]]"
										:src="baseUrl+scope.row.images.split(',')[0]" style="width:100px;height:100px" @click.stop>
									</el-image>
								</div>
								<div v-else>无图片</div>
							</template>
						</el-table-column>
						<el-table-column label="处理状态" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.status}}
							</template>
						</el-table-column>
						<el-table-column label="举报类型" :resizable='true' align="left" header-align="left">
							<template #default="scope">
