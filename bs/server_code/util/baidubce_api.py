...
class BaiDuBce(object):
    client_id = 'DPinK7BkM3yI4Qptnr0eFZNH'  # ak
    client_secret = 'wmZbglKccAGMBwzZCyn9IVQfK2ObRAtc'  # sk
    ...
    def bd_check2pic(self, image1, image2):
        ...
        params = json.dumps(
            [{"image": self.open_pic2base64(image1), "image_type": "BASE64", "face_type": "LIVE",
              "quality_control": "LOW"},
             {"image": self.open_pic2base64(image2), "image_type": "BASE64", "face_type": "LIVE",
              "quality_control": "LOW"}])
    ...
    def ocr_checkpic(self, image):
        ...
        return "".join([item.get("words") for item in json_res.get("words_result")])
    ...
    def advanced_general(self, image):
        ...
        access_token = self.get_alitoken()
        request_url = "https://aip.baidubce.com/rest/2.0/image-classify/v2/advanced_general?access_token={}".format(
            access_token)
    ...
    def bodynum_checkpic(self, image):
        ...
        access_token = self.get_alitoken()
        request_url = "https://aip.baidubce.com/rest/2.0/image-classify/v1/body_num?access_token={}".format(
            access_token)
